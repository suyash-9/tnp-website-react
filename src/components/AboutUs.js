...
export default function Aboutus() {
  return (
    <>
      ...
      >
        "The Training and Placement Office at DSPM IIIT-Naya Raipur is concerned
        with every activity that enables students to learn and grow outside the
        Institute campus. On one hand, it collaborates with leading
        ...
        discussions, tests, and interviews and other logistics required for the
        same. 
        <br/>
        <br/>
        
        The Training and Placement Cell of DSPM IIIT-Naya Raipur strives
        to get every student trained in the Institute placed in an organization
